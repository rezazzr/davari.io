    ...
    <div>
      ...
      <div className="mt-8 space-y-4">
        {courses.map((course, i) => (
          <RevealOnScroll key={course.name} delay={i * REVEAL_ANIMATION_DELAY_INCREMENT_MS}>
            <TiltCard className="rounded-xl border border-black/5 dark:border-white/5 bg-surface shadow-sm transition-shadow hover:shadow-md">
              <Link
                href={course.link}
                className="block p-6"
              >
